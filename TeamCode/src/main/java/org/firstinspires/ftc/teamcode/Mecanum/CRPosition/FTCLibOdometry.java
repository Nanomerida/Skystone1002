 ...
 * More information on the mecanum system can be found .
 */
public class FTCLibOdometry {
     ...
     */
    public FTCLibOdometry(double trackWidth) {
     ...
     * @param trackWidth the track width of the robot in inches
     */
    public FTCLibOdometry(Pose2d pose, double trackWidth) {
        robotPos = pose;
